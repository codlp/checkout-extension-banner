...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-extension-banner/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const title = merchantTitle != null ? merchantTitle : translate("banner_title");
    const description = merchantDescription != null ? merchantDescription : translate("banner_description");
    const collapsible = merchantCollapsible != null ? merchantCollapsible : false;
    const status = merchantStatus != null ? merchantStatus : "success";
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title, collapsible, status, children: description });
  }
})();
//# sourceMappingURL=checkout-extension-banner.js.map
